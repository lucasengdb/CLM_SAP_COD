 ...
 */
public class GAP007_SeReprovado extends CLMDummyWorkflow {
    ...
    private void movePrevPhase(int index) throws
        ...
        if (docPhase.getPrevPhaseList().size() == 0) {
            cancelProcess("Não é possivel voltar uma fase por não ter nenhuma configurada para a fase atual.");
            return;
        }
    ...
    private void inicio() throws
        ...
        try {
            ...
            movePrevPhase(0);       // Deve voltar para a fase "Revisão Solicitante"
        } catch (Exception e) {
