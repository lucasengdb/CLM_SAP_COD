...
public class GAPTESTE_LUCAS extends CLMDummyWorkflow {

	/**
	 * MA Collab Validation - DocOnly - Any Atende: - GAP032 (Validação de
	 * Perfis) - Valida quando adicionado algum aprovador com uma representação
