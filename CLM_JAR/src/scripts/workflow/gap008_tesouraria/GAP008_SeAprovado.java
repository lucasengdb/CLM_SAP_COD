package scripts.workflow.gap008_tesouraria;
 ...
 */
public class GAP008_SeAprovado extends CLMDummyWorkflow {

    // Constantes do Script
    private final String LOGGER_ID = "\n[Workflow 008 - Tesouraria] ";
    // Variaveis
    ResultSet rs;
    String idContrato = "";
    String nomeDocCon = "";
    ...
    private void moveNextPhase(int index) throws
        ...
        if (docPhase.getNextPhaseList().size() == 0) {
            cancelProcess("Não é possivel avançar à uma fase anterior por não ter nenhuma configurada para a fase atual.");
            return;
        }
