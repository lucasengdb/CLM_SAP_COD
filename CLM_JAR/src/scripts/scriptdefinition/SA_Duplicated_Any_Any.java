 ...
 */
public class SA_Duplicated_Any_Any extends CLMDummyScriptDefinition {
    ...
    private void aprovSoc_lockUnlockExtFieldNumero(boolean mustLock, String extFieldName, int numCampoBase1) throws ApplicationException {
    ...
    private ExtensionFieldIfc aprovSoc_getExtFieldNumbered(String extFieldName, int numCampoBase1) throws ApplicationException {
        if (numCampoBase1 == 0) {
