 ...
 *
 */
public class SA_PrePublish_Any_Any extends CLMDummyScriptDefinition {
    ...
    private void gap018_vigenciaDocContrato() throws ApplicationException, DatabaseException {
        ...
        // Pegando todos os documentos de contrato do contrato pai
        AssociativeCollectionIfc docContratos = docPai.getContractDocuments();
        Integer docPhaseId;
        ...
        // Datas de inicio e vencimento do acordo basico pai
        dataInicioAcordo = (SysDate) docPai.getEffectiveDate();
        dataFimAcordo = (SysDate) docPai.getExpirationDate();
    ...
    public void inicio() throws ApplicationException {
        try {
            // Coletando o contrato pai
            docPai = (ContractIBeanIfc) doc.getParentIBean();
