...
/*
 ...
 - Quando for colaborador adicionado pelo "Workflow Process Owner"  será eleiminado todos que 
 estiverem sem representação, se for qualquer usuário que esteja adicionando um colaborador 
 sem representação somente  o alertará que precisa atribuir uma representação
 - Valida quando adicionado algum aprovador com uma representação que não corresponde a suas 
 permissões configuradas em seu perfil
 */
